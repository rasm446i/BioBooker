...
namespace BioBooker.WinApp.Bll
{
    public class MoviesManager : IMoviesManager
    {
        ...
        {
            Movie newMovie = new Movie(movie.Id, movie.Title, movie.Genre, movie.Actors, movie.Director, movie.Language, movie.ReleaseYear, movie.Subtitles, movie.SubtitlesLanguage, movie.MPARatingEnum, movie.RuntimeMinutes, movie.PremierDate, movie.Poster);
